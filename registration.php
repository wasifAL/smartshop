...
//        insert into database and complete registration
        if ($status === 1) {
            $sql = "INSERT INTO `user`(`username`, `password`, `full_name`, `email`, `role`, `contact_no`, `address`, `gender`, `zip_code`)"
                    . " VALUES ('$username','$password','$full_name','$email','$role','$phone','$address','$gender','$zip_code')";
            if ($conn->query($sql)) {
            ...
            <table class="table table-responsive">
                ...
                <tr class="form-group">
                    ...
                    <td class="input-group">
                        ...
                        <input  name="full_name" value="<?php if ($status === 0) echo $full_name; ?>" placeholder="First Name" class="form-control"  type="text" required> 
                    </td>
                ...
                <tr class="form-group">
                    ...
                    <td class="input-group">
                        ...
                        <input name="phone" placeholder="8801700000000" value="<?php if ($status === 0) echo $phone; ?>"  class="form-control" type="tel" required>
                    </td>
                ...
                <tr class="form-group">
                    ...
                    <td class="input-group">
                        ...
                        <input name="address" placeholder="Shipping Address"  value="<?php if ($status === 0) echo $address; ?>" class="form-control" type="text" required>
                    </td>
